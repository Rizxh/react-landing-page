...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      ...
      whileInView="show"
      viewport={{ once: true }}
      className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm z-50 border-b border-zinc-100 shadow-sm"
    >
      <div className="w-full flex justify-between items-center container mx-auto px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        ...
        >
          <img src="./fav-cion.png" alt="Logo" width={40} height={40} className="h-16 w-16" />
          {/* <motion.div 
